<script lang="ts">
    ...
    function handleNotificationClick(notification: any) {
        ...
        if (notification.data?.applicationId) {
            window.location.href = '/app/company/applications';
        } else if (notification.data?.placementId) {
            window.location.href = `/app/company/placements`;
    ...
    {#if notifications.length === 0}
        <Card>
            <CardContent class="flex flex-col items-center justify-center py-12">
                ...
                <p class="text-muted-foreground text-center">When students apply to your placements or send messages, they'll appear here.</p>
            </CardContent>
        </Card>
    {:else}
        <div class="space-y-2">
